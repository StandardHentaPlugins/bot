...
async function answer(response) {
    ...
    this.answered = true;
    const messageBuilder = creator_1.default(response);
...
function builder(response) {
    ...
    messageBuilder['answer'] = () => this.answer(messageBuilder);
    messageBuilder['bad'] = () => this.bad(messageBuilder);
    return messageBuilder;
}
function getPayloadValue(field) {
    return this.messagePayload && this.messagePayload[field];
}
function addStandardContextMethods(contextService, botPlugin) {
...
exports.default = addStandardContextMethods;
