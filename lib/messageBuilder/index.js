...
const dataToMsg_1 = __importDefault(require("./dataToMsg"));
...
class MessageBuilder {
    constructor(data, defaultValues) {
        ...
        if (data) {
            Object.assign(this.msg, dataToMsg_1.default(data));
        }
    ...
    replyTo(messageId) {
        this.msg.reply_to = messageId;
        return this;
    }
    forward(messageIds) {
        this.msg.forwards = Array.isArray(messageIds) ? messageIds.join(',') : messageIds;
        return this;
    }
    keyboard(keyboard) {
    ...
    kebord(rawButtons, rawOptions = {}) {
        ...
        const keyboard = vk_io_1.Keyboard.builder();
        buttons.forEach((v, i) => {
    ...
    attach(attachment) {
        if (Array.isArray(attachment)) {
            attachment.forEach(v => this.attach(v));
            return this;
        }
        if (!this.msg.attachment) {
            this.msg.attachment = [];
    ...
    audioMessage(source) {
        return this.attach(this.context.vk.upload.audioMessage({
    ...
    video(source) {
        ...
        return this.attach((async () => this.context.vk.upload.video({
            ['is_private']: 1,
